...
```bash
git clone git@github.com:ghostwriter/case-converter.git
cd case-converter
git remote add upstream git://github.com/ghostwriter/case-converter.git
```
